            ...
            var buff = $('<div style="position:fixed;top:10px;"></div>').appendTo('body'),
                ...
                doFixed = function() {
                    me.css({
                     ...
                     me.css('width', document.body.offsetWidth);
                };
    ...
    gmu.define( 'Slider', {
        ...
        template: {
            item: '<div class="ui-slider-item"><a href="<%= href %>">' +
                    '<img src="<%= pic %>" alt="" style="width:100%;"/></a>' +
                    '<% if( title ) { %><p><%= title %></p><% } %>' +
                    '</div>'
        },
