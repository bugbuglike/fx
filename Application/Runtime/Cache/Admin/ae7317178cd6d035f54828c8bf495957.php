...
<?php if(isset($message)): ?><h1><img src="/wfx/Public/Common/img/success.png"/></h1>
<p class="success" style="text-align: center"><?php echo($message); ?></p>
<?php else: ?>
<h1><img src="/wfx/Public/Common/img/failed.png"/></h1>
<p class="error" style="text-align: center"><?php echo($error); ?></p><?php endif; ?>
<p class="detail"></p>
<p class="jump">
