		...
		<div class="widget">
			...
			<div class="widget-body">
				<div class="table-toolbar">
					<a href="<?php echo U('Admin/Shop/adsSet/');?>" class="btn btn-primary" data-loader="App-loader" data-loadername="设置广告">
					...
					<div class="pull-right">
						<form id="App-search">
							...
							<a href="<?php echo U('Admin/Shop/ads/');?>" class="btn btn-success" data-loader="App-loader" data-loadername="商城广告" data-search="App-search">
				...
				<table id="App-table" class="table table-bordered table-hover">
					...
					<tbody>
						<?php if(is_array($cache)): $i = 0; $__LIST__ = $cache;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="item<?php echo ($vo["id"]); ?>">
								...
								<td class=" "><?php echo ($vo["mark"]); ?></td>
								<td class="center "><a href="<?php echo U('Admin/Shop/adsSet/',array('id'=>$vo['id']));?>" class="btn btn-success btn-xs" data-loader="App-loader" data-loadername="设置广告"><i class="fa fa-edit"></i> 编辑</a>&nbsp;&nbsp;<a href="<?php echo U('Admin/Shop/adsDel/');?>" class="btn btn-danger btn-xs" data-type = "del" data-ajax="<?php echo U('Admin/Shop/adsDel/',array('id'=>$vo['id']));?>" ><i class="fa fa-trash-o"></i> 删除</a></td>
...
<script type="text/javascript">
	...
	$('#App-delall').on('click',function(){
		...
		var toajax="<?php echo U('Admin/Shop/adsDel');?>"+"/id/"+chk;
		var callok=function(){
			//主框架可以直接模拟点击刷新按钮
