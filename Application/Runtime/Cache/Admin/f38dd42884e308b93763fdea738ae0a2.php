    ...
    <div class="col-xs-12 col-xs-12">
        <div class="widget radius-bordered">
            <div class="widget-header bg-blue">
                ...
                <span class="widget-caption">广告设置</span>
            ...
            <div class="widget-body">
                <form id="AppForm" action="" method="post" class="form-horizontal" data-bv-message="" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                    ...
                    <div class="form-title">
                        <a href="<?php echo U('Admin/Shop/ads/');?>" class="btn btn-primary" data-loader="App-loader" data-loadername="商城广告">
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label">广告图片<sup>*</sup></label>
                        <div class="col-lg-4">
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control" name="pic" value="<?php echo ($cache["pic"]); ?>" data-bv-notempty="true" data-bv-notempty-message="不能为空" id="App-pic">
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label">广告链接<sup>*</sup></label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="url" placeholder="必填" data-bv-notempty="true" data-bv-notempty-message="不能为空" value="<?php if(empty($cache["url"])): ?>#<?php endif; echo ($cache["url"]); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label">使用备注</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="mark" placeholder="例：首页顶部广告" value="<?php echo ($cache["mark"]); ?>">
                        </div>
                    </div>
                    <div class="form-group">
...
$('#AppForm').bootstrapValidator({
    submitHandler: function(validator, form, submitButton) {
        var tourl = "<?php echo U('Admin/Shop/adsSet');?>";
