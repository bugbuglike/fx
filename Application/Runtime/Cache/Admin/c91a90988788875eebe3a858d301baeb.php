                ...
                <div class="table-toolbar">
                    ...
                    <div class="pull-right">
                        <form id="App-search">
                            ...
                            <a href="<?php echo U('Admin/Vip/vipRebornList/');?>" class="btn btn-success" data-loader="App-loader" data-loadername="会员调配中心" data-search="App-search">
                ...
                <table id="App-table" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <?php if(is_array($cache)): $i = 0; $__LIST__ = $cache;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="item<?php echo ($vo["id"]); ?>">
                                ...
                                <td class=" "><img width="50px" src="<?php echo ($vo["headimgurl"]); ?>" /></td>
...
$("#vipReborn").on('click', function () {
    ...
    bootbox.prompt(msg, function (result) {
        if (result != null) {
            ...
            var tourl="<?php echo U('Admin/vip/vipReborn');?>";
