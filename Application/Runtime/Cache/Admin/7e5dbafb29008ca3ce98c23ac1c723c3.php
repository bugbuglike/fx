                        ...
                        <?php if(is_array($artical)): $i = 0; $__LIST__ = $artical;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$artical): $mod = ($i % 2 );++$i;?><tr id="item<?php echo ($vo["id"]); ?>">
                                ...
                                <td>
                                    ...
                                    <div class="action-buttons" style="cursor: pointer;">
                                        <a class="table-actions" data-loader="App-loader" data-loadername="文章管理" href="<?php echo U('Admin/Artical/add',array('id' => $artical['id']));?>">修改</a>
                                        <a class="table-actions" data-loader="App-loader" data-loadername="文章管理" href="<?php echo U('Admin/Artical/del',array('id' => $artical['id']));?>">删除</a>
                                    </div>
                                </td>
