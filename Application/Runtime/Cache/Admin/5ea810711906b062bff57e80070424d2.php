...
.sonmenu {
    margin-top: 20px;
    padding-left: 80px;
    background: url('/Public/Admin/img/bg_repno.gif') no-repeat -245px -545px;
}
...
<div class="row">
    <div class="col-xs-12 col-md-12">
        <div class="widget">
            <form id="form" action="<?php echo U('Admin/Wx/menu');?>" method="post" target='frame'>
            ...
            <div class="widget-body">
                <table class="table table-bordered table-hover">
                    <tbody class="mlist">
                        <?php if(is_array($menu["button"])): $i = 0; $__LIST__ = $menu["button"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                <td>
                                    ...
                                    <div class="smlist">
                                        <?php if(is_array($vo["sub_button"])): $i = 0; $__LIST__ = $vo["sub_button"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?><div class="sonmenu" data-type="<?php echo ($sub["type"]); ?>" data-url="<?php echo ($sub["url"]); ?>" data-key="<?php echo ($sub["key"]); ?>">
...
$('#AppForm').bootstrapValidator({
    submitHandler: function(validator, form, submitButton) {
        var tourl = "<?php echo U('Admin/Wx/menu');?>";
